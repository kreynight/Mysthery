...
const INVENTORY = [
  ...
  {inventoryNo:46,name:"Alishan Jin Xuan Oolong",brand:"Wedear",teaNumber:null,category:"Oolong",ingredientsKey:"Jin Xuan (TRES #12) oolong tea",flavorNotes:"creamy, milky, light floral",wellnessFunction:"antioxidants; gentle alertness",caffeineLevel:"Medium",culturalRoots:"Taiwan (Alishan, Chiayi County)",format:"single-serve sachet (2.5g)",verificationLevel:"THREAD_LOG",notes:"Jin Xuan cultivar known for natural milky aroma from lactones; semi-oxidized"},
  {inventoryNo:47,name:"Caramelised Biscuit Brew",brand:"Yorkshire Tea (Taylors of Harrogate)",teaNumber:null,category:"Flavored black tea",ingredientsKey:"Black tea; natural flavouring (4%)",flavorNotes:"caramel, biscuit, malty, buttery",wellnessFunction:"comfort/uplift",caffeineLevel:"Medium",culturalRoots:"British (Harrogate, Yorkshire)",format:"box (40 tea bags, 112g)",verificationLevel:"THREAD_LOG",notes:"Dairy-free and vegan despite buttery taste; Biscoff-style caramel flavor"},
  {inventoryNo:48,name:"Gyokuro, Hojicha & Sencha Assortment",brand:"Ippodo Tea",teaNumber:null,category:"Japanese green tea assortment",ingredientsKey:"Gyokuro (mecha/konacha); sencha (mecha/konacha); hojicha (roasted bancha)",flavorNotes:"umami, grassy, roasted",wellnessFunction:"antioxidants; calm focus (gyokuro L-theanine); evening-friendly (hojicha)",caffeineLevel:"Medium",culturalRoots:"Japan (Kyoto, est. 1717)",format:"box (12 teabags, 2g each, 24g total)",verificationLevel:"THREAD_LOG",notes:"4 bags each of gyokuro, sencha, hojicha"},
  {inventoryNo:49,name:"Mikan Ryokucha",brand:"Fukujuen",teaNumber:null,category:"Flavored green tea",ingredientsKey:"Japanese green tea (sencha); mandarin orange peel (mikan/chimpi)",flavorNotes:"citrus, sweet mandarin, grassy green tea",wellnessFunction:"refreshing; antioxidants",caffeineLevel:"Low",culturalRoots:"Japan (Kyoto, est. 1790)",format:"leaf teabags (10 bags)",verificationLevel:"THREAD_LOG",notes:"Product of Japan; chimpi (dried mikan peel) is a traditional Japanese ingredient"},
  {inventoryNo:50,name:"White Peach & Green Rooibos (Cold Brew)",brand:"MUJI",teaNumber:null,category:"Rooibos",ingredientsKey:"Green rooibos; natural white peach flavoring",flavorNotes:"sweet peach, light, refreshing",wellnessFunction:"caffeine-free hydration; relaxation",caffeineLevel:"None",culturalRoots:"Japan (MUJI) / South Africa (rooibos origin)",format:"pouch (10 bags, 3g each, 30g total)",verificationLevel:"THREAD_LOG",notes:"Cold brew only: steep in 500ml room temp water, refrigerate 4 hours; non-caffeinated"},
  {inventoryNo:51,name:"Cherry Berry Ruchi",brand:"Miro Tea",teaNumber:null,category:"Fruit herbal blend",ingredientsKey:"Cherries; elderberries; rosehips; hibiscus; cranberries; blackberries; raspberries",flavorNotes:"sweet berry, tart, fruity",wellnessFunction:"antioxidant-rich; refreshing",caffeineLevel:"None",culturalRoots:"modern artisan blend (Seattle, WA)",format:"pouch (loose, 2 oz)",verificationLevel:"THREAD_LOG",notes:"Naturally sweet; steep 3g per 8oz boiling water, 4-5 min"},
  {inventoryNo:52,name:"Rosewood",brand:"Miro Tea",teaNumber:null,category:"Herbal blend",ingredientsKey:"Fireweed; yarrow flowers; lavender; rose petal",flavorNotes:"rich, syrupy, sweet floral",wellnessFunction:"calming; caffeine-free evening tea",caffeineLevel:"None",culturalRoots:"modern artisan blend (Seattle, WA)",format:"pouch (loose, 2 oz)",verificationLevel:"THREAD_LOG",notes:"Organic flowers brighten the rich fireweed; pairs well with desserts"},
  {inventoryNo:53,name:"Nakamuracha",brand:"Nakamura Tokichi Honten",teaNumber:null,category:"Japanese green tea blend",ingredientsKey:"Green tea (Kyoto Prefecture); blend of 7 types including sencha and gyokuro",flavorNotes:"complex, aromatic, umami-rich",wellnessFunction:"antioxidants; calm focus",caffeineLevel:"Medium",culturalRoots:"Japan (Uji, Kyoto; est. 1854)",format:"teabags (4g x 10 bags)",verificationLevel:"THREAD_LOG",notes:"Proprietary blend ratio of 7 teas; signature product of the house"},
  {inventoryNo:54,name:"Gyokuro Kinkaku",brand:"Fukujuen",teaNumber:null,category:"Gyokuro (shade-grown green tea)",ingredientsKey:"Gyokuro green tea (Uji, Kyoto)",flavorNotes:"rich umami, mellow sweetness, subtle bitterness",wellnessFunction:"antioxidants; L-theanine for calm alertness",caffeineLevel:"High",culturalRoots:"Japan (Uji, Kyoto; est. 1790)",format:"leaf teabags (2g x 10 bags)",verificationLevel:"THREAD_LOG",notes:"Shade-grown 20-30 days before harvest; high theanine content; Uji meichya designation"},
  {inventoryNo:55,name:"Throat Coat Lemon Echinacea",brand:"Traditional Medicinals",teaNumber:null,category:"Herbal (medicinal wellness)",ingredientsKey:"Echinacea purpurea root; licorice root; marshmallow leaf; marshmallow root; fennel fruit; orange peel; cinnamon bark; lemon peel; lemon myrtle leaf oil",flavorNotes:"herbal, licorice-sweet, lemon, warm spice",wellnessFunction:"throat health; immune support",caffeineLevel:"None",culturalRoots:"western herbalism (USDA Organic)",format:"individually wrapped tea bags (2g each)",verificationLevel:"THREAD_LOG",notes:"USDA Organic; Non-GMO Project verified; herbal supplement classification"},
];
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: `Init failed: ${msg}` }, { status: 500 });
  }
}
